...
LICENSE_APP_VERSION = os.environ.get(
    "LIVEWATCH_APP_VERSION",
    license_runtime.LICENSE_APP_VERSION or "1.0.0",
).strip() or "1.0.0"
LICENSE_REFRESH_INTERVAL_SEC = max(30, int(os.environ.get("LIVEWATCH_LICENSE_REFRESH_INTERVAL_SEC", "60")))
